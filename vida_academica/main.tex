    ...
    \begin{itemize}
      ...
      \item Condomínio de chalés. Lugar bem próximo da UFSCar (especificamente 10 minutos a pé).
          Na região, não há muitas opções de mercado e também não há circular de domingo, portanto se programe.
            É um bom lugar para ter várias horas de sono e maximizar a economia do dinheiro. O preço varia de R\$600 a R\$800 (depende do proprietário/imobiliária e localização), com o condomínio incluso na grande maioria dos casos, mas você poderia dividir o espaço com cerca de 3 pessoas.
    \end{itemize}
...
\begin{multicols}{2}
  ...
  \end{itemize}
  \begin{itemize}
    \item \textbf{Shopping Cidade (dead inside)}
