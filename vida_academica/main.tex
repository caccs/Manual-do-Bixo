...
Os ônibus da cidade de Sorocaba não possuem cobradores. Para utilizar o transporte é preciso possuir passe, que atualmente custa R\$ 4,10. Estudantes podem adquirir passe de ônibus por R\$ 1,60 (Os ônibus da cidade tem um sistema de cartões de passes que precisam ser feitos junto a faculdade - secretária).
...
\subsubsection{Links De compras/vendas/trocas}
  \begin{itemize}
    \item Brechó UFSCar <https://www.facebook.com/groups/1601374806746482>
  \end{itemize}
...
O responsável por abrir e cuidar desses laboratórios é o nosso técnico Tiago, porém caso seja necessário o Centro Acadêmico tem a permissão de abrir os laboratórios para estudos, o horário de serviço do Tiago é geralmente das 9h - 17h.
...
Cada curso da UFSCar tem uma secretaria, ela é responsável por mandar e-mails de estágios, avisos de professores, informações da faculdade em geral e entregas de documentos são geralmente entregues a ela.
...
Até ano passado nós tínhamos a cantinas que vendia salgados, almoço e bebidas em geral, porém no ano de 2017 por problemas contratuais ela fechou, enquanto não temos uma cantina, temos alunos e pessoas de fora que vendem diferentes tipos de comida e bebidas, até mesmo comidas veganas.
