...
A página da Proace (Pró reitoria de Assuntos Comunitários e Estudantis) \newline \texttt{<https://goo.gl/K3SUAR>} possui mais informações sobre as bolsas e auxílio aos estudantes.
...
\newline \newline Maiores informações sobre esta bolsa podem ser encontradas no link \newline{\texttt{<http://www.proace.ufscar.br>}
...
\indent O link para se obter mais informações é \texttt{<https://goo.gl/BCMTdC>}
