...
\noindent{Este ônibus possui cobrador e o valor atual da passagem é R\$ 5,80.}
...
\begin{multicols}{2}
  ...
  \begin{itemize}
    \item \textbf{The SmallBig Bar}
      \newline Av. Dr. Armando Pannunzio, 1330 - Jardim Piazza Di Roma, Sorocaba - SP
      \newline Horário: Seg-Dom: 17h às 00h
      \newline (15) 98803-9700
  \end{itemize}
  \begin{itemize}
...
Tem mais informações no link a seguir. Desde bares até os shows que acontecem. Sempre tem coisa legal rolando por Sorocaba, então não custa nada entrar pra dar uma olhadinha. \url{http://agendasorocaba.com.br/}
...
ou acesse as redes do RU, as fontes mais atualizadas de informações sobre o funcionamento do mesmo e o cardápio do dia

Facebook: \url{https://www.facebook.com/RU.UFSCar}

Instagram: \url{https://www.instagram.com/restauranteuniversitarioufscar/}
...
\noindent \textbf{Nome, e-mail e telefone}
  ...
  \newline (15) 3229-6176
  \newline bccs@ufscar.br; mcastilho@ufscar.br; alunosccso@ufscar.br
